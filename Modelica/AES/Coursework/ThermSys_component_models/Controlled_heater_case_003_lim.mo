...
model Controlled_heater_case_003_lim
...
equation
  ...
  annotation(
    Diagram(coordinateSystem(extent = {{-200, -100}, {200, 100}}), graphics = {Text(origin = {-87, -67}, extent = {{-81, 13}, {81, -13}}, textString = "Compare with Controlled_heater_case_003_ideal")}),
...
end Controlled_heater_case_003_lim;