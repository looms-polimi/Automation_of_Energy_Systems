...
model IMC_scheme_2dof
  ...
  Modelica.Blocks.Continuous.TransferFunction HF(a = {0.1, 1.1, 1}, b = {10, 11, 1})  annotation(
  ...
  Modelica.Blocks.Continuous.TransferFunction Cff(a = {5, 1}, b = {1, 1}) annotation(
...
equation
  ...
  connect(LD.y, ald.u1) annotation(
    Line(points = {{-119, 70}, {22, 70}, {22, 36}, {38, 36}}, color = {0, 0, 127}));
  ...
  connect(SP.y, Cff.u) annotation(
    Line(points = {{-118, 24}, {-102, 24}}, color = {0, 0, 127}));
