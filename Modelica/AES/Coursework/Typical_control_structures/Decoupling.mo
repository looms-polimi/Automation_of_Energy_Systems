...
equation
  connect(D.CS2, P.u2) annotation(
    Line(points = {{40, 6}, {60.2, 6}}, color = {0, 0, 127}));
  connect(D.CS1, P.u1) annotation(
    Line(points = {{40, 14}, {60, 14}}, color = {0, 0, 127}));
  ...
  connect(P.y1, C1.PV) annotation(
    Line(points = {{80, 14}, {100, 14}, {100, 90}, {-60, 90}, {-60, 40}, {-40, 40}}, color = {0, 0, 127}));
  connect(P.y2, C2.PV) annotation(
    Line(points = {{80, 6}, {100, 6}, {100, -70}, {-60, -70}, {-60, -20}, {-40, -20}}, color = {0, 0, 127}));
