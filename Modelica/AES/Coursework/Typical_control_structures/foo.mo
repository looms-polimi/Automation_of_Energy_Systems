...
model foo
  ...
  AES.ControlBlocks.DigitalControllers.PI_awfb_full C1(K = 4, hasBias = true)  annotation(
    Placement(visible = true, transformation(origin = {-30, 50}, extent = {{-10, 20}, {10, -20}}, rotation = 0)));
  AES.ControlBlocks.DigitalControllers.PI_awfb_full C2(K = 4, Ti = 1.2, hasBias = true)  annotation(
