...
model FF_compensation_with_delay
  ...
  Modelica.Blocks.Nonlinear.FixedDelay Dc(delayTime = 4) annotation(
...
equation
  ...
  connect(d.y, H.u) annotation(
    Line(points = {{2, 70}, {50, 70}, {50, 10}, {58, 10}}, color = {0, 0, 127}));
  connect(H.y, Dd.u) annotation(
    Line(points = {{82, 10}, {98, 10}}, color = {0, 0, 127}));
  connect(Dd.y, ad.u1) annotation(
    Line(points = {{122, 10}, {132, 10}, {132, -32}, {138, -32}}, color = {0, 0, 127}));
