...
model Heater_control_case_002
  ...
  AES.ProcessComponents.Thermal.Piping_liquid.Tube delivery(L = 10) annotation(
...
equation
  ...
  connect(Hon.y, CH.ON) annotation(
    Line(points = {{-119, -16}, {-100, -16}}, color = {255, 0, 255}));
  connect(pressuriser.pwh_a, CH.pwh_a) annotation(
    Line(points = {{-82, -40}, {-110, -40}, {-110, -10}, {-100, -10}}, color = {46, 52, 54}));
