...
model Valve_linearisation_case_001
  ...
  AES.ProcessComponents.Thermal.Piping_liquid.Valve_linear valveNL annotation(
    Placement(visible = true, transformation(origin = {-70, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression xv(y = max(0, min(1, 0.01 * time))) annotation(
    Placement(visible = true, transformation(origin = {-110, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ProcessComponents.Thermal.Piping_liquid.TubeStream streamLIN(L = 20000) annotation(
    Placement(visible = true, transformation(origin = {30, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ProcessComponents.Thermal.Piping_liquid.Valve_linear valveLIN annotation(
