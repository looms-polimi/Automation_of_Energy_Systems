...
model Thermal_zones_case_01
  ...
  AES.ControlBlocks.AnalogueControllers.PI_awfb_full C1(CSmax = 1000, CSmin = 0, K = 300, Ti = 100, hasBias = true) annotation(
    Placement(visible = true, transformation(origin = {-65, 50}, extent = {{-7, 14}, {7, -14}}, rotation = 0)));
  AES.ControlBlocks.AnalogueControllers.PI_awfb_full C2(CSmax = 1000, CSmin = 0,K = 300, Ti = 100, hasBias = true) annotation(
    Placement(visible = true, transformation(origin = {-60, -42}, extent = {{-10, -20}, {10, 20}}, rotation = 0)));
...
equation
  connect(SP1.y, C1.SP) annotation(
    Line(points = {{-133, 14}, {-102.5, 14}, {-102.5, 30}, {-72, 30}}, color = {0, 0, 127}));
  connect(SP2.y, C2.SP) annotation(
    Line(points = {{-133, -18}, {-102.5, -18}, {-102.5, -14}, {-70, -14}}, color = {0, 0, 127}));
  connect(D.BiasToC1, C1.Bias) annotation(
    Line(points = {{-20, 2}, {-20, 22}, {-65, 22}}, color = {0, 0, 127}));
  connect(D.BiasToC2, C2.Bias) annotation(
    Line(points = {{-20, -6}, {-20, 12}, {-60, 12}, {-60, -2}}, color = {0, 0, 127}));
  connect(C1.CS, D.CSfromC1) annotation(
    Line(points = {{-58, 30}, {-40, 30}, {-40, 6}, {-20, 6}}, color = {0, 0, 127}));
  connect(C2.CS, D.CSfromC2) annotation(
    Line(points = {{-50, -14}, {-35, -14}, {-35, -10}, {-20, -10}}, color = {0, 0, 127}));
  ...
  connect(sTz1.T, C1.PV) annotation(
    Line(points = {{62, -60}, {-82, -60}, {-82, 36}, {-72, 36}}, color = {0, 0, 127}));
  connect(sTz2.T, C2.PV) annotation(
    Line(points = {{32, -80}, {-86, -80}, {-86, -22}, {-70, -22}}, color = {0, 0, 127}));
  annotation(
