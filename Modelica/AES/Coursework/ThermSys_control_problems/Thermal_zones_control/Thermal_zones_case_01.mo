...
model Thermal_zones_case_01
  ...
  AES.ControlBlocks.AnalogueControllers.PI_awfb_full C1(CSmax = 1000, CSmin = 0, K = 300, Ti = 100, hasBias = true) annotation(
    Placement(visible = true, transformation(origin = {-72, 68}, extent = {{-10, 20}, {10, -20}}, rotation = 0)));
  AES.ControlBlocks.AnalogueControllers.PI_awfb_full C2(CSmax = 1000, CSmin = 0,K = 300, Ti = 100, hasBias = true) annotation(
    Placement(visible = true, transformation(origin = {-66, -40}, extent = {{-10, -20}, {10, 20}}, rotation = 0)));
...
equation
  connect(SP1.y, C1.SP) annotation(
    Line(points = {{-133, 14}, {-102.5, 14}, {-102.5, 40}, {-82, 40}}, color = {0, 0, 127}));
  connect(SP2.y, C2.SP) annotation(
    Line(points = {{-133, -18}, {-103.5, -18}, {-103.5, -12}, {-76, -12}}, color = {0, 0, 127}));
  connect(D.BiasToC1, C1.Bias) annotation(
    Line(points = {{-22, -2}, {-22, 28}, {-72, 28}}, color = {0, 0, 127}));
  connect(D.BiasToC2, C2.Bias) annotation(
    Line(points = {{-22, -10}, {-22, 12}, {-66, 12}, {-66, 0}}, color = {0, 0, 127}));
  connect(C1.CS, D.CSfromC1) annotation(
    Line(points = {{-62, 40}, {-40, 40}, {-40, 2}, {-22, 2}}, color = {0, 0, 127}));
  connect(C2.CS, D.CSfromC2) annotation(
    Line(points = {{-56, -12}, {-37, -12}, {-37, -14}, {-22, -14}}, color = {0, 0, 127}));
  ...
  connect(sTz1.T, C1.PV) annotation(
    Line(points = {{62, -60}, {-82, -60}, {-82, 48}}, color = {0, 0, 127}));
  connect(sTz2.T, C2.PV) annotation(
    Line(points = {{32, -80}, {-86, -80}, {-86, -20}, {-76, -20}}, color = {0, 0, 127}));
  annotation(
