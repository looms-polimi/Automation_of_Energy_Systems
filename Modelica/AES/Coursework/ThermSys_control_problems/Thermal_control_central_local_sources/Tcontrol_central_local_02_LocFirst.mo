...
model Tcontrol_central_local_02_LocFirst
...
equation
  ...
  connect(DC1.CSo01[1], Prange1.CSi01) annotation(
    Line(points = {{0, 28}, {12, 28}}, color = {0, 0, 127}));
  connect(DC1.CSo01[2], Grange1.CSi01) annotation(
  ...
  connect(DC2.CSo01[1], Prange2.CSi01) annotation(
    Line(points = {{0, -72}, {12, -72}}, color = {0, 0, 127}));
  connect(DC2.CSo01[2], Grange2.CSi01) annotation(
...
end Tcontrol_central_local_02_LocFirst;