...
model HN_heating_station_control
  ...
  ProcessComponents.Thermal.Liquid.DiffPressureSensor sdp annotation(
    Placement(visible = true, transformation(origin = {70, -30}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ControlBlocks.AnalogueControllers.PI_awfb_basic PI_dpHC(CSmin = 0, K = 1e-6, Ti = 5) annotation(
    Placement(visible = true, transformation(origin = {30, 50}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ProcessComponents.Thermal.Liquid.Pump_centrifugal P(dp00 = 1500000, dpn0 = 1200000, wn0 = 20) annotation(
    Placement(visible = true, transformation(origin = {-70, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ProcessComponents.Thermal.Liquid.Tube line(L = 1000, wnom = 5, hasInertia = true) annotation(
  ...
  ProcessComponents.Thermal.Liquid.Tube load(L = 100, wnom = 5) annotation(
    Placement(visible = true, transformation(origin = {140, -62}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ProcessComponents.Thermal.Liquid.surfTcond_fixed Tload(T = 291.15) annotation(
  ...
  ProcessComponents.Thermal.Liquid.ExpansionVessel_isoT EV(V = 1, p0 = 399999.9999999999) annotation(
  ...
  ProcessComponents.Thermal.Liquid.Tsensor sTo annotation(
    Placement(visible = true, transformation(origin = {-172, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ControlBlocks.AnalogueControllers.PI_awfb_basic PI_To(CSmax = 1e6, CSmin = 0, K = 1e6, Ti = 500) annotation(
    Placement(visible = true, transformation(origin = {-166, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ControlBlocks.AnalogueControllers.PI_awfb_basic PI_wh(CSmin = 0, K = 0.2, Ti = 1) annotation(
  ...
  ProcessComponents.Thermal.Liquid.Valve_linear Vload annotation(
  ...
  ProcessComponents.Thermal.Liquid.Header heater(V = 5) annotation(
...
end HN_heating_station_control;