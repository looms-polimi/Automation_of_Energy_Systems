...
model AHU_control_case_001
  ...
  AES.ProcessComponents.Thermal.Air.MAvolume Room2(Tstart(displayUnit = "K") = 291.15, V = 5 * 5 * 3, phistart = 0.6) annotation(
    Placement(visible = true, transformation(origin = {100, -80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  AES.ProcessComponents.Thermal.Air.MAvolume Room1(Tstart(displayUnit = "K") = 291.15, V = 5 * 5 * 3, phistart = 0.6) annotation(
