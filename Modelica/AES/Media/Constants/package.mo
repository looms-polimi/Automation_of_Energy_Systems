...
package Constants "Pakage with constants"
  ...
  final constant SI.SpecificHeatCapacity Ra = 286.9 "Gas constant of dry air";
  final constant SI.SpecificHeatCapacity Rv = 461.5 "Gas constant of water vapour in moist air";
  final constant SI.Density d_l = 1000 "density of subcooled water";
  final constant SI.MolarMass MMa = 24 "molar mass of dry air";
  final constant SI.MolarMass MMw = 14 "molar mass of water";
