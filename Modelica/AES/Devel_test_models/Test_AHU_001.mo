...
model Test_AHU_001
  ...
  AES.ProcessComponents.Thermal.Air.MAvolume V(Tstart(displayUnit = "K") = 291.15, phistart = 0.55)  annotation(
...
protected
  annotation(
    experiment(StartTime = 0, StopTime = 2000, Tolerance = 1e-6, Interval = 0.2),
