...
equation
  ...
  connect(pumpV.pwh_b, tubeH.pwh_a) annotation(
    Line(points = {{-18, -30}, {-2, -30}}, color = {46, 52, 54}));
  connect(cmdP.y, pumpV.cmd) annotation(
    Line(points = {{-99, 10}, {-30, 10}, {-30, -22}}, color = {0, 0, 127}));
  ...
  connect(pressuriser.pwh_b, pumpV.pwh_a) annotation(
