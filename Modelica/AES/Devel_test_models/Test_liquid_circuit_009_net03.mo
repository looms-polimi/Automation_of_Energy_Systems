...
model Test_liquid_circuit_009_net03
  ...
  ProcessComponents.Thermal.Liquid.ExpansionVessel_isoT ev(p0 = 499999.9999999999)  annotation(
...
equation
  ...
  connect(ev.pwh_b, pumpC.pwh_a) annotation(
    Line(points = {{-232, 30}, {-202, 30}}, color = {46, 52, 54}));
  connect(tube08.pwh_a, ev.pwh_a) annotation(
    Line(points = {{-102, -10}, {-268, -10}, {-268, 30}, {-256, 30}}, color = {46, 52, 54}));
  connect(tube18.pwh_b, ev.pwh_a) annotation(
    Line(points = {{-102, -50}, {-268, -50}, {-268, 30}, {-256, 30}}, color = {46, 52, 54}));
protected
  annotation(
...
end Test_liquid_circuit_009_net03;