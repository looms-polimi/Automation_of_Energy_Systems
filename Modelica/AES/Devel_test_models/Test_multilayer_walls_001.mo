...
model Test_multilayer_walls_001
  extends Icons.TestModel;
  AES.ProcessComponents.Thermal.Containment.SolidMultilayer_Homogeneous homogeneous(s = 0.1)  annotation(
    Placement(visible = true, transformation(origin = {-10, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  AES.ProcessComponents.Thermal.Containment.SolidMultilayer_NonHomogeneous nonhomogeneous(lambda = {2.4, 0.02, 0.1}, ro(displayUnit = "kg/m3"), s = {0.02, 0.05, 0.01})  annotation(
