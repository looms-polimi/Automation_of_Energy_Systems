...
model Test_liquid_circuit_006_net01
  ...
  AES.ProcessComponents.Thermal.Piping_liquid.Pump_centrifugal pumpC(w0 = 5)  annotation(
...
end Test_liquid_circuit_006_net01;